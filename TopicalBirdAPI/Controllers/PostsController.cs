...
namespace TopicalBirdAPI.Controllers
{
    ...
    public class PostsController : ControllerBase
    {
        ...
        /// <summary>
        /// Creates a new post for an authenticated user in a specified Nest (community).
        /// </summary>
        ...
        /// <response code="404">If the specified Nest (community) is not found.</response>
        ...
        /// </summary>
        /// <param name="postId">The unique identifier (GUID) of the post.</param>
        ...
        /// <summary>
        /// Gets a paged list of posts belonging to a specific Nest (community).
        /// </summary>
        /// <param name="nestTitle">The title of the Nest where posts will be fetched.</param>
        ...
        /// <summary>
        /// Gets a paged list of posts created by a specific user via their ID.
        /// </summary>
        ...
        /// <summary>
        /// Gets a paged list of posts created by a specific user via their username/handle.
        /// </summary>
        /// <param name="userHandle">The username or handle of the user.</param>
        /// <param name="pageNo">Page number to fetch. Defaults to 1.</param>
        /// <param name="limit">Amount of posts that will be returned per page. Maximum is 50. Defaults to 20.</param>
        /// <returns>A paged list of posts authored by the user.</returns>
        /// <response code="200">Returns the paged list of posts.</response>
        ...
        /// <summary>
        /// Gets popular posts, sorted by total votes and optionally filtered by a specific Nest.
        /// </summary>
        /// <param name="nest">Title of the Nest (community) where posts will be fetched. Optional.</param>
        /// <param name="pageNo">Page number to fetch. Defaults to 1.</param>
        /// <param name="limit">Amount of posts that will be returned per page. Maximum is 50. Defaults to 20.</param>
        ...
        /// <summary>
        /// Updates the content of an existing post. Only the author can update a post.
        /// </summary>
        /// <param name="postId">The unique identifier (GUID) of the post to update.</param>
        ...
        /// <summary>
        /// Deletes a post by its ID. Only the author or an Admin can delete a post.
        /// </summary>
